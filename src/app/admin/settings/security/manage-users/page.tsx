        ...
        <Table>
            ...
            <TableBody>
                ...
                <TableCell className="font-medium">
                    <Image src={user} alt="avatar" className="w-10 h-10 rounded-full" />
                ...
                <TableCell className="flex gap-2">
                    <button className="cursor-pointer bg-red-warning   text-white px-4 py-2 rounded-md"><FaTrash /></button>
                    <button className="cursor-pointer bg-dusk  text-white px-4 py-2 rounded-md"><FaPen /></button>
                </TableCell>
                </TableRow>
            </TableBody>
        </Table>
