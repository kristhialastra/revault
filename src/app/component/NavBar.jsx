...
export default function NavBar() {
    return (
        <>
            <header className="flex flex-row align-middle items-center justify-between text-xl font-mono  w-full bg-dark p-8 px-16">
                <div className="flex align-middle items-center gap-10">
                <h1 className="font-bold text-3xl text-teal">ReVault</h1>
