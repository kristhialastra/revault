const WarningMessage = ({
  ...
  return (
    <div
      className={`flex items-center gap-4 h-12 mt-2 bg-teal/10 p-4 rounded-md ${containerClassName}`}
    >
      {/* Icon Container */}
      ...
      <p className={`text-teal text-sm leading-tight w-full ${textClassName}`}>
        {message}
      </p>
    </div>
  );
