  ...
  return (
    <div className={`flex flex-col w-auto ${theme === 'light' ? 'bg-secondary border-white-50' : 'bg-midnight'} mr-10 p-6 rounded-xl border-1 border-white-5`}>
      ...
      <div className="flex flex-col md:flex-row gap-5 m-5">
        ...
        <div className="flex flex-col justify-center items-center">
          <button
            className={`flex flex-col items-center justify-center py-3 px-6 bg-neutral-800 text-gray-200 w-3xs h-32 rounded-lg cursor-pointer outline-2 ${theme === 'light' ? 'bg-neutral-800 text-gray-200' : 'bg-neutral-800 text-gray-200 outline-2 outline-white-50 outline-offset-4'}`}
